-- ============================================
-- CREAR ESQUEMA V2 CON NOMBRES EN INGLÉS
-- Este script crea las tablas NUEVAS en inglés
-- Las tablas antiguas en español se mantienen intactas
-- ============================================
...
-- ============================================
-- PASO 2: Crear tabla PRODUCTS (en inglés)
-- ============================================
-- NOTA: Esta es una tabla NUEVA, diferente de 'productos' (si existe)
...
-- ============================================
-- PASO 3: Crear tabla TRANSACTIONS (en inglés)
-- ============================================
-- NOTA: Esta es una tabla NUEVA, diferente de 'transacciones' (si existe)
...
-- ============================================
SELECT 
  '✅ Esquema V2 creado correctamente' AS status,
  'Tablas: products (inglés) y transactions (inglés)' AS detalle,
  'Las tablas antiguas (español) se mantienen intactas' AS nota;
